    ...
    <footer className="footer">
      <div className="footer__container container">
        <div className="footer__content">
          ...
          <div className="footer__section">
            <h4 className="footer__subtitle">{t('footer.navigation')}</h4>
            <ul className="footer__links">
              <li><Link to="/">{t('nav.home')}</Link></li>
              <li><Link to="/catalog">{t('nav.catalog')}</Link></li>
              <li><Link to="/my-courses">{t('nav.myCourses')}</Link></li>
              <li><Link to="/teaching">{t('nav.teaching')}</Link></li>
              <li><Link to="/profile">{t('nav.profile')}</Link></li>
            </ul>
          </div>

          <div className="footer__section">
            <h4 className="footer__subtitle">{t('footer.about')}</h4>
            <ul className="footer__links">
          ...
          <div className="footer__section">
            <h4 className="footer__subtitle">{t('footer.support')}</h4>
            <ul className="footer__links">
